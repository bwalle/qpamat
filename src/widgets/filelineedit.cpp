 ...
 *
 * This must be no valid file but it makes sense.
 *
 ...
 *
 * It is not guarenteed that it is a valid file.
 *
...
/**
 * @brief Sets a filter for the dialog.
 *
 ...
 *
 * It displays a file dialog and lets the user choose the file.
 */
