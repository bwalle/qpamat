 ...
 *
 * This class provides a QListBoxItem with a (big) picture and some text as usual in KDE
...
/**
 * @brief Creates a new instance of a ListBoxLabeledPict.
 *
...
/**
 * @brief Returns a pointer to the pixmap hold by this class.
 *
...
/**
 * @brief Draws the pixmap using \a painter.
 */
...
/**
 * @brief Returns the height of the pixmap in list box \a lb.
 *
 * @sa paint(), width()
 */
...
/**
 * @brief Returns the width of the pixmap plus some margin in list box \a lb.
 *
 * @sa paint(), height()
 */
