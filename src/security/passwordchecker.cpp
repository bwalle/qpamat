...
/**
 * @brief Number of checks a "modern" computer can do in one second.
 *
 * From time to time this value will be increased. It is irrelevant how fast the computer
 * on which QPaMaT runs is, the cracker uses another machine!
 */
 ...
 *
 * A password checker checks the quality of a password. The quality is measured in days
 * that a cracker needs to crack the password. We assume 500000 tests per second, that is
 * defined in the constant CRACKS_PER_SECOND, defined in this class.
 *
 * @ingroup security
 ...
 *         password checker
 * @exception PasswordCheckException if checking the password failed, e.g. a
 *            file does not exist
 */
