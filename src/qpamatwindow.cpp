...
/*!
    ...
    It makes no sense to have more than one instances of this class. There's a global pointer \c
    qpamat which holds the address of the qpamat. This pointer is initialized \em after the full
    initialization of QpamatWindow, i.e. don't use it in constructors of Tree and RightPanel because
    theses are generated by QpamatWindow and therefore \c qpamatwindow is not initialized (it's just
    \c 0).
